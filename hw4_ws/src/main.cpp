...
int main()
{
    ...
    double sigma = 1.0; // Tukey loss parameter is std dev of noise. Essentially, inlier cutoff distance.
    ...
    for (int i = 0; i < num_files; ++i)
    {
        ...
        if(i > 0)
        {
            ...
            //     *downpcd, *prev_pcd, *fpfh, *prev_fphf, true, 0.15,
            //     open3d::pipelines::registration::TransformationEstimationPointToPoint(false), 3,
            //     correspondence_checker,
            //     open3d::pipelines::registration::RANSACConvergenceCriteria(2000, 0.99)
            // );
            ...
            auto reg_p2l = open3d::pipelines::registration::RegistrationICP(*downpcd, *prev_downpcd, threshold, trans_init, p2l);
